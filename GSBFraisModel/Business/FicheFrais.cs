...
namespace GSBFraisModel.Business
{
    public class FicheFrais
    {
        ...
        private List<LigneFraisForfait> lesLignesFraisForfait = new List<LigneFraisForfait>();
        private List<LigneFraisHorsForfait> lesLignesFraisHorsForfait = new List<LigneFraisHorsForfait>(); 
