...
namespace GSBFraisModel.Data
{
    public class DaoFicheFrais
    {
        ...
        {
            string query = "fichefrais SET " + "idVisiteur = '" + uneFicheFrais.UnVisiteur.Id + "' , mois = '" + uneFicheFrais.Mois + "' , nbJustificatifs = '" + uneFicheFrais.Nbjustificatif + "' , montantValide = '" + uneFicheFrais.MontantValide + "' , dateModif = '" + uneFicheFrais.DateModif + "' , idEtat = '" + uneFicheFrais.UnEtat.Id;
