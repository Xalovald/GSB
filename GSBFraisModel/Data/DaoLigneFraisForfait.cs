...
namespace GSBFraisModel.Data
{
    public class DaoLigneFraisForfait
    {
        ...
        {
            string query = " ligneFraisForfait (idVisiteur, mois, idFraitForfait, quentite) SET '" + uneLigneFraisForfait.FicheFrais + "','" + uneLigneFraisForfait.FicheFrais + "','" + uneLigneFraisForfait.FicheFrais + "','" + uneLigneFraisForfait.Quantite + "'";
        ...
        */
        public List<LigneFraisForfait> SelectByFicheFrais(FicheFrais uneFicheFrais)
        {
            ...
            foreach(DataRow r in myTable.Rows)
            {
                ...
                listesLignesFraisForfait.Add(new LigneFraisForfait((decimal)r["quantite"], uneFicheFrais, leFraisForfait));
            }
